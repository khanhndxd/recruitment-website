...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AId).HasName("PK__Applicat__71AD61D9CDFEF279");
        ...
        {
            entity.HasKey(e => e.EId).HasName("PK__Employer__D7E94DAC1358B996");
        });

        modelBuilder.Entity<Job>(entity =>
        {
            entity.HasKey(e => e.JId).HasName("PK__Job__92B5B2AB6C987073");
        ...
        modelBuilder.Entity<Resume>(entity =>
        {
            ...
            entity.HasMany(d => d.AIds).WithMany(p => p.RIds)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("RId", "AId").HasName("PK__Intermed__590EFCDCD49CAB67");
